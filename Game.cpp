...
bool Game::init()
{
    ...
    control_text.setString("   PLayer-1: 'W' = UP  'S' = DOWN \n   Player-2: 'Arrow UP' = UP  'Arrow DOWN' = DOWN");
    control_text.setFont(font);
    control_text.setCharacterSize(21);
    control_text.setFillColor(sf::Color::Blue);
    ...
    pause_text.setFillColor(sf::Color::Magenta);
    ...
    quit_text.setString("Press O to quit the game.");
    quit_text.setFont(font);
    quit_text.setCharacterSize(20);
    quit_text.setFillColor(sf::Color::Magenta);
    ...
    speed_ball_text.setString("Speed: " + to_string(ball_vector[0]));
    speed_ball_text.setFont(font);
    speed_ball_text.setCharacterSize(20);
    speed_ball_text.setFillColor(sf::Color::Cyan);
    ...
    // Sprite settings //
    if (!ball_texture.loadFromFile("Data/Images/ballFire.png"))
    {
        cout << "Ball texture could not be loaded.\n";
    }
    ...
    if (!p1_texture.loadFromFile("Data/Images/paddleGreen.png"))
    {
        cout << "Player 1 paddle texture could not be loaded.\n";
    }
    ...
    if (!p2_texture.loadFromFile("Data/Images/paddlePink.png"))
    {
        cout << "Player 2 paddle texture could not be loaded.\n";
    }
